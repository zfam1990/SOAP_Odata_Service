CLASS zcl_odata_test_123 DEFINITION
PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_odata_test_123 IMPLEMENTATION.


  METHOD if_rap_query_provider~select.

    DATA: lt_business_data TYPE TABLE OF zrap_123z_travel_agency_es5,
    ...
    TRY.
        ...
        TRY.
            lo_client_proxy = cl_web_odata_client_factory=>create_v2_remote_proxy(
              EXPORTING
                iv_service_definition_name = 'ZSC_RAP_AGENCY_123'
        ...
        lo_request = lo_client_proxy->create_resource_for_entity_set( 'Z_TRAVEL_AGENCY_ES5' )->create_request_for_read( ).
